        ...
        <div className="flex flex-row mx-auto w-full justify-center2 items-center">
          <div className="flex justify-between w-full  px-8 py-4 border-y border-gray-800 bg-white">
            <div className="flex  items-center space-x-2">
                <select id="countries" class="bg-yellow-100 border border-gray-800 text-gray-900 text-sm font-mabry rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <select id="countries" class="bg-yellow-100 border border-gray-800 text-gray-900 font-mabry text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div className="relative flex flex-row w-full mx-auto space-x-4 justify-center2 items-center bg-white px-4 py-4 rounded-md shadow">
                  ...
                  <div className="flex w-2/3 flex-col space-y-1">
                    ...
                    <div className="flex space-x-3 items-center text-red-600">
                        <div className="text-[10px] font-mabry py-1 px-2 border-red-700 rounded-lg bg-red-300 text-red-700 capitalize">call of duty</div>
