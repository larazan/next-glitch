...
Want to share large code snippets? Share them through our pastebin.
              ...
              <div class="md:col-span-5">
                ...
                <form>
    <div class="mb-4 w-full bg-gray-50 mt-2 rounded md:rounded-lg border border-gray-200 dark:bg-gray-50 dark:border-gray-200">
        ...
        <div class="py-2 px-4 bg-white rounded-b-lg dark:bg-gray-800">
            ...
            <textarea id="editor" rows="8" class="block px-0 w-full text-sm text-gray-800 bg-white border-0  focus:ring-0 dark:text-white dark:placeholder-gray-500" placeholder="Write an article..." required></textarea>
        </div>
    </div>
