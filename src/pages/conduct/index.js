            ...
            <div className=" bg-primary-dark md:rounded-xl md:max-w-5xl md:mx-auto py-8 px-4 md:p-8">
              <div className="prose max-w-lg mx-auto owl">
                ...
                <p>
                  ...
                  body size, disability, ethnicity, sex characteristics, gender
                ...
                <p>
                  ...
                  behavior may be reported by contacting the project team at the
                  venue or write us a message via Meetup or
                  <a href="https://twitter.com/webzuerich">Twitter</a>. All
