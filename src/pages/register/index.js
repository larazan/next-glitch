            ...
            <div className="flex flex-1 flex-col w-10/12 justify-center space-y-3 md:space-y-5 max-w-md">
              ...
              <div className="flex flex-col space-y-1 md:space-y-2">
                ...
                <p className="text-md md:text-md text-gray-400">
                  ...
                  <Link href={"/login"}>
                  <span className="text-[#2680fb] hover:opacity-70">Log in</span>
                  </Link>
                </p>
              </div>
              <div className="flex flex-col max-w-md space-y-4 md:space-y-5">
                <div className="relative w-full">
                  <input
                    ...
                    className="flex w-full px-3 py-3 md:px-4 md:py-4 border-2 bg-white border-gray-300 rounded font-medium placeholder:font-normal"
                  />
                </div>
                {/* <div className="relative w-full">
                  <input
