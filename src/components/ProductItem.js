...
import product1 from "@/img/products/produk1.png";
  ...
  return (
    <>
      <div className="flex gap-x-4 py-2 lg:px-6 border-b border-gray-200 w-full font-light text-gray-500">
        <div className="w-full min-h-[70px] flex items-center gap-x-2">
          <Link
            href={"/shop/product-4"}
            className="border rounded-sm bg-gray-100 p-1"
          >
            <Image src={product1} alt="" className="max-w-[60px]" />
          </Link>
          <div className="w-full flex flex-col">
            <div className="flex justify-between mb-2">
              <div className="flex flex-col max-w-[240px]">
                <span className="text-xs font-mabrybold uppercase">
                  Savory Chews
                </span>
                <Link
                  href={"/shop/product-4"}
                  className="text-xs font-mabry hover:underline"
                >
                  Salmon Savory Chews
                </Link>
              </div>
            ...
            <div className="flex gap-x-2 h-[36px] text-sm">
              ...
              <div className="flex-1 flex justify-end items-center font-mabry">
                $ 99,00
              </div>
            </div>
          </div>
