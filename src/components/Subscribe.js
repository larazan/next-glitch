    ...
    <>
      <div>
        ...
        <div class="relative flex justify-center max-w-xl py-4 m-auto bg-white shadow-2xl">
          <span class="absolute top-0 right-0 block w-10 h-5 -mt-2 -mr-4 text-xs text-center text-gray-600 transform rotate-45 bg-white rounded shadow-md cursor-pointer hover:bg-gray-100">
            close
          </span>
          <div
          ...
          <div class="flex flex-col justify-between w-1/2 px-4 space-y-16">
            ...
            <div>
              <form>
                <input
                  class="w-full px-5 py-3 border rounded focus:border-blue-500 focus:outline-none"
                  type="email"
                  placeholder="Email address"
                />
                <button
                  class="block w-full py-3 mt-3 text-white bg-blue-500 rounded shadow-lg hover:bg-blue-600"
                  type="submit"
                >
                  Subscribe
                </button>
