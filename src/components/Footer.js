      ...
      <footer aria-label="Site Footer" className="bg-black lg:grid lg:grid-cols-5">
        ...
        <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2">
            <div>
              <div className="mt-8 space-y-1 text-2xl font-mabrybold text-[#ffff00]">
                <span>
              ...
              <div className="mt-4 flex w-full">
                <input
                  type="text"
                  className="p-3 px-4 w-full border border-grey-light font-mabry rounded-l text-gray-900 text-md h-auto"
                  placeholder="Your email address"
                />
                <button className="bg-[#ffff00] text-black rounded-r h-auto text-xs p-3">
                  <svg
          ...
          <div className="pt-12 ">
            <div className="sm:flex  sm:items-center sm:justify-between">
              ...
              <p className="mt-8 text-md font-mabrybold text-[#ffff00] sm:mt-0">
                &copy; Company Name.
              </p>
            </div>
          </div>
