...
export default function CookieConfirm() {
    return (
      <>
        <section class="w-full z-30 p-5 lg:px-24 absolute bottom-0 bg-gray-600" x-show="showCookieBanner">
        <div class="md:flex items-center -mx-3">
            ...
            <div class="px-3 text-center">
                <button id="btn" class="py-2 px-8 bg-gray-800 hover:bg-gray-900 text-white rounded font-bold text-sm shadow-xl mr-3" >Cookie settings</button>
                <button id="btn" class="py-2 px-8 bg-green-400 hover:bg-green-500 text-white rounded font-bold text-sm shadow-xl" >Accept cookies</button>
            </div>
        </div>
    </section>
      </>
