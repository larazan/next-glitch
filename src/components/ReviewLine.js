    ...
    <>
      <div id="template_horizontal-image-slider">
          ...
          <div>
            <div class="flex flex-wrap items-center justify-center2 mt-2">
              <div class="flex-initial flex flex-col justify-center items-center">
                <svg
                  class="w-12 text-gray-600 transition-all duration-300 ease-out transform fill-current stroke-current hover:text-blue-600 hover:scale-110"
                  viewBox="0 0 72 72"
        ...
        <div className=" pt-[14px] mb-[1em] h-full ">
          ...
          >
            <SwiperSlide>
              <div class="bg-white w-[350px] rounded-md px-6 py-3 pb-6 shadow-lg hover:shadow-2xl transition duration-500">
                <div class="mt-2">
                  <div class="flex justify-between items-center pb-4 border-b">
                    <div class=" flex items-center space-x-4">
                      ...
                      <div class="text-sm font-semibold font-mabrybold">
                        John Lucas •{" "}
                        <span class="font-mabry"> 5 minutes ago</span>
                      </div>
                    </div>
                  </div>
                  <div class="flex mt-4">
                  ...
                  <p class="mt-3 text-[17px] text-gray-600 font-mabry leading-tight">
