    ...
    <>
      <div id="template_horizontal-image-slider">
        <div className="flex flex-col ">
          <div>
            <span className="font-mabrybold uppercase text-lg">Ratings</span>
          </div>
          <div className="flex flex-col">
        ...
        <div className=" pt-[14px] mb-[1em] h-full ">
          ...
          >
            <SwiperSlide>
              <div className="bg-white w-[220px] md:w-[350px] rounded-md px-4 md:px-6 py-3 pb-6 shadow-lg hover:shadow-2xl transition duration-500">
                <div className="mt-2">
                  ...
                  <p className="mt-3 text-sm md:text-[17px] text-gray-600 font-mabry leading-tight">
