...
export default function Filter({ open }) {
  ...
  return (
    <>
      <div className="h-max flex pt-6 flex-col px-4 md:px-6 justify-center2 items-center2 bg-[#f6f8f7]">
            ...
            <div className="flex w-full py-4 px-4">
              <div className="w-full flex flex-col space-x-1">
                ...
                <div className="flex flex-col w-full space-y-1">
                  <div className="flex justify-between items-center">
                    <div>
                      <span className="font-mabry">All Console</span>
                    </div>
                    <input
                      type="checkbox"
                      id="A3-yes"
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      <span className="font-mabry">Android</span>
                    </div>
                    <input
                      type="checkbox"
                      id="A3-yes"
                  ...
                  <div className="flex justify-between items-center">
                    <div>
                      <span className="font-mabry">PC games</span>
                    </div>
                    <input
                      type="checkbox"
                      id="A3-yes"
